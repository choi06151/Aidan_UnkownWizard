...
#include "KJH/RealTimeAudioCaptureComp.h"

bool URealTimeAudioCaptureComp::Init(int32& SampleRate)
{
	NumChannels = 1;
...
int32 URealTimeAudioCaptureComp::OnGenerateAudio(float* OutAudio, int32 NumSamples)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
...
void URealTimeAudioCaptureComp::SetFrequency(const float InFrequencyHz)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
